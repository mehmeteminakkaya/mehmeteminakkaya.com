...
[![Website](https://img.shields.io/badge/Canl%C4%B1%20Site-mehmeteminakkaya.com-11130f?style=for-the-badge&logo=vercel&logoColor=white)](https://mehmeteminakkaya.com)
[![Vercel Deployment](https://img.shields.io/badge/Deploy-Vercel%20Production-blue?style=for-the-badge&logo=vercel)](https://mehmeteminakkaya-com.vercel.app)
[![Tech Stack](https://img.shields.io/badge/Stack-HTML5%20%7C%20Vanilla%20CSS%20%7C%20Web%20Audio-orange?style=for-the-badge)](https://mehmeteminakkaya.com)
...
* **💻 Canlı Etkileşimli CLI Terminal (`#lab`):** Klavyeden gerçek komutları çalıştıran dahili terminal (`help`, `projects`, `migo`, `kobiflow`, `studybuddy`, `skills`, `cv`, `contact`, `theme`, `matrix`, `sudo`).
...
```mermaid
graph TD
    Client[Ziyaretçi Tarayıcısı] -->|HTTPS| Edge[Vercel Global Edge Network]
    Edge --> HTML[index.html & Gömülü WOFF2 Fontlar]
    HTML --> CSS[Editorial Design System & CSS Variables]
    HTML --> Audio[Web Audio API Synthesizer]
    HTML --> Terminal[Interactive CLI & Command Router]
    HTML --> Palette[⌘K Command Palette Dialog]
    HTML --> CV[Modal CV Viewer & Print CSS Engine]
```
