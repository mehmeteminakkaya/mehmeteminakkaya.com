...
* **💻 Canlı Etkileşimli CLI Terminal (`#lab`):** Klavyeden gerçek komutları çalıştıran dahili terminal (`help`, `projects`, `migo`, `nexus`, `studybuddy`, `skills`, `cv`, `contact`, `theme`, `matrix`, `sudo`).
